# Para fazer comentários em python, use # na linha de código.
# O comentário começará a partir da #.
# Então, na linha de código que você usar uma #, nada após ela será executado.


# Por exemplo, nessa linha, só será executado até print('braia k k k')
print('braia k k k')
